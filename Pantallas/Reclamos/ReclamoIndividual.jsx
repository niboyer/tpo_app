...
import { getMovimientosReclamoByIdReclamo } from '../../Controllers/Reclamos.controller';
...
export default function ReclamoIndividual({ item, route, navigation }) {
    ...
    useEffect(()=>{
          async function componentDidMount(){
              let rdo = await getMovimientosReclamoByIdReclamo(idReclamo);
              setData(rdo);
          }
          componentDidMount();
      }, []);
      ...
      return (
        <View style={styles.container}>
          <ScrollView style={styles.ScrollView}>
            <Text style={styles.titulo}>Reclamo N°: {idReclamo}</Text>
            ...
            <View style={styles.datos}>
              <Text style={styles.subtitulo}>Datos del reclamo</Text>
              <View style={styles.subdatos}>
